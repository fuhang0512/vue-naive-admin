 ...
 * @LastEditTime: 2022-10-31 14:31:34
 * @LastEditors: 
 * @FilePath: \vue-naive-admin\src\store\modules\theme\helpers.ts
 */
...
export function initThemeSettings(): Theme.Setting {
  ...
  const sidebar = themeSetting.sidebar || { width: 220, collapsedWidth: 64, collapsed: false }
  ...
  return { isMobile, darkMode, sidebar, header, tab, primaryColor, otherColor }
}
